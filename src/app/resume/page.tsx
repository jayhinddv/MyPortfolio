...
import { experience, expertise, seoKeywords, siteConfig } from "@/data/site";
    ...
    <>
      ...
      <section className="container-shell section-space">
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
          <SectionHeading
            eyebrow="Resume"
            title="Backend-focused full-stack engineering resume."
            description="A concise scan of my production experience, technical scope, and delivery responsibilities."
          />
        ...
        <div className="mt-8 grid gap-7 lg:grid-cols-[0.72fr_1.28fr]">
          ...
          <div className="grid gap-0 border-y border-[color:var(--line)]">
            {experience.map((job) => (
